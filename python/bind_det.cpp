...
static void bind_hycal(py::module_ &m)
{
    ...
    py::class_<fdec::ClusterConfig>(m, "HyCalClusterConfig",
        ...
        .def_readwrite("density_correction", &fdec::ClusterConfig::density_correction)
        .def_readwrite("s_shape_energy_correction",
               &fdec::ClusterConfig::s_shape_energy_correction)
    ...
    py::class_<fdec::ClusterHit>(m, "ClusterHit",
        ...
        .def_readonly("energy_square", &fdec::ClusterHit::energy_square)
        .def_readonly("energy_s_shape_corr", &fdec::ClusterHit::energy_s_shape_corr)
